...
<template>
    <section class="section-user">
        <div class="section__content">
            <div class="section__user-info base-form">
            ...
            <MyCardsSection v-if="user.cards.length != 0"
                ...
                <RouterLink v-for="(card, index) in user.cards" :to="{name: 'transactions_for_account', params: {id: card.id}, query: {index}}" class="card_link">
                    <Card :card
